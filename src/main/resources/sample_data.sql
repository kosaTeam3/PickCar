...
INSERT INTO car (branch_id, vehicle_id_number, model, price, brand, year, age_limit, fuel_type, car_number, mileage,
                 status, purchase_price, model_price, seater, color, created_at, updated_at)
VALUES (7, 'KMHCT41CDPA006001', '아반떼', 55000, '현대', 2023, 21, 'GASOLINE', '66허6001', 6100, 'WAITING', 21000000,
        23000000, 5, 'WHITE', NOW(), NOW()),
       (7, 'KMHCT41CDPA006002', '아반떼', 55000, '현대', 2023, 21, 'GASOLINE', '66허6002', 11500, 'DRIVING', 21000000,
        23000000, 5, 'BLACK', NOW(), NOW()),
       (7, 'KMHCT41CDPA006003', '아반떼', 55000, '현대', 2023, 21, 'GASOLINE', '66허6003', 21000, 'WAITING', 21000000,
        23000000, 5, 'GRAY', NOW(), NOW()),
       (7, 'KMHGN41JDPA006004', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허6004', 3200, 'WAITING', 28000000,
        31000000, 5, 'WHITE', NOW(), NOW()),
       (7, 'KMHGN41JDPA006005', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허6005', 9500, 'DRIVING', 28000000,
        31000000, 5, 'BLACK', NOW(), NOW()),
       (7, 'KMHGN41JDPA006006', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허6006', 15600, 'MAINTENANCE', 28000000,
        31000000, 5, 'GRAY', NOW(), NOW()),
       (7, 'KNAGD41LDPA006007', 'K5', 72000, '기아', 2023, 21, 'GASOLINE', '66호6007', 8800, 'WAITING', 27000000, 30000000,
        5, 'WHITE', NOW(), NOW()),
       (7, 'KNAGD41LDPA006008', 'K5', 72000, '기아', 2023, 21, 'GASOLINE', '66호6008', 21000, 'DRIVING', 27000000,
        30000000, 5, 'BLACK', NOW(), NOW()),
       (7, 'KNAGD41LDPA006009', 'K5', 72000, '기아', 2023, 21, 'GASOLINE', '66호6009', 32500, 'WAITING', 27000000,
        30000000, 5, 'GRAY', NOW(), NOW()),
       (7, 'KMHCT41CDPA006010', '아반떼', 55000, '현대', 2023, 21, 'GASOLINE', '66허6010', 4200, 'WAITING', 21000000,
        23000000, 5, 'WHITE', NOW(), NOW()),
       (7, 'KMHCT41CDPA006011', '아반떼', 55000, '현대', 2023, 21, 'GASOLINE', '66허6011', 11000, 'WAITING', 21000000,
        23000000, 5, 'BLACK', NOW(), NOW()),
       (7, 'KMHGN41JDPA006012', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허6012', 5500, 'WAITING', 28000000,
        31000000, 5, 'GRAY', NOW(), NOW()),
       (7, 'KMHGN41JDPA006013', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허6013', 17800, 'DRIVING', 28000000,
        31000000, 5, 'WHITE', NOW(), NOW()),
       (7, 'KNAGD41LDPA006014', 'K5', 72000, '기아', 2023, 21, 'GASOLINE', '66호6014', 12100, 'WAITING', 27000000,
        30000000, 5, 'BLACK', NOW(), NOW()),
       (7, 'KNAGD41LDPA006015', 'K5', 72000, '기아', 2023, 21, 'GASOLINE', '66호6015', 28500, 'MAINTENANCE', 27000000,
        30000000, 5, 'GRAY', NOW(), NOW()),
       (7, 'KMHCT41CDPA006016', '아반떼', 55000, '현대', 2023, 21, 'DIESEL', '66허6016', 42000, 'WAITING', 23000000, 25000000,
        5, 'WHITE', NOW(), NOW()),
       (7, 'KMHGN41JDPA006017', '소나타', 75000, '현대', 2024, 21, 'DIESEL', '66허6017', 51000, 'WAITING', 30000000, 33000000,
        5, 'BLACK', NOW(), NOW()),
       (7, 'KNAGD41LDPA006018', 'K5', 72000, '기아', 2023, 21, 'DIESEL', '66호6018', 62000, 'DRIVING', 29000000, 32000000,
        5, 'GRAY', NOW(), NOW());
