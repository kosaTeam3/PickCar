...
-- 공덕지점(7): 시나리오 기반 18대 데이터 적재
INSERT INTO car (branch_id, vehicle_id_number, model, price, brand, year, age_limit, fuel_type, car_number, mileage,
                 maintenance_date, status, purchase_price, model_price, seater, color, created_at, updated_at)
VALUES
-- 케이스 1. [정상/신차] 알림이 하나도 없어야 함 (5대)
(7, 'VIN-NORMAL-001', '아반떼', 55000, '현대', 2025, 21, 'GASOLINE', '66허1001', 1200, '2025-10-01', 'WAITING', 21000000, 23000000, 5, 'WHITE', NOW(), NOW()),
(7, 'VIN-NORMAL-002', '아반떼', 55000, '현대', 2025, 21, 'GASOLINE', '66허1002', 3500, '2025-11-15', 'DRIVING', 21000000, 23000000, 5, 'BLACK', NOW(), NOW()),
(7, 'VIN-NORMAL-003', '아반떼', 55000, '현대', 2025, 21, 'GASOLINE', '66허1003', 5000, '2025-08-20', 'WAITING', 21000000, 23000000, 5, 'GRAY', NOW(), NOW()),
(7, 'VIN-NORMAL-004', '아반떼', 55000, '현대', 2025, 21, 'GASOLINE', '66허1004', 7000, '2025-09-01', 'WAITING', 21000000, 23000000, 5, 'WHITE', NOW(), NOW()),
(7, 'VIN-NORMAL-005', '아반떼', 55000, '현대', 2025, 21, 'GASOLINE', '66허1005', 8500, '2025-12-01', 'DRIVING', 21000000, 23000000, 5, 'BLACK', NOW(), NOW()),

-- 케이스 2. [소모품 지남] due: true가 여러 개 떠야 함 (5대)
(7, 'VIN-OVER-001', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허2001', 10500, '2025-01-10', 'WAITING', 28000000, 31000000, 5, 'WHITE', NOW(), NOW()), -- 엔진오일 초과
(7, 'VIN-OVER-002', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허2002', 21000, '2024-06-15', 'DRIVING', 28000000, 31000000, 5, 'BLACK', NOW(), NOW()), -- 에어클리너 초과
(7, 'VIN-OVER-003', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허2003', 52000, '2024-01-20', 'MAINTENANCE', 28000000, 31000000, 5, 'GRAY', NOW(), NOW()), -- 타이어/브레이크 초과
(7, 'VIN-OVER-004', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허2004', 101000, '2023-01-01', 'WAITING', 28000000, 31000000, 5, 'WHITE', NOW(), NOW()), -- 전체 소모품 초과
(7, 'VIN-OVER-005', '소나타', 75000, '현대', 2024, 21, 'GASOLINE', '66허2005', 11000, '2025-02-01', 'DRIVING', 28000000, 31000000, 5, 'BLACK', NOW(), NOW()),

-- 케이스 3. [교체 임박] remainingKm가 작게 나와야 함 (4대)
(7, 'VIN-SOON-001', 'K5', 72000, '기아', 2023, 21, 'GASOLINE', '66호3001', 9800, '2025-01-14', 'WAITING', 27000000, 30000000, 5, 'WHITE', NOW(), NOW()), -- 200km 남음
(7, 'VIN-SOON-002', 'K5', 72000, '기아', 2023, 21, 'GASOLINE', '66호3002', 19700, '2024-12-15', 'WAITING', 27000000, 30000000, 5, 'BLACK', NOW(), NOW()), -- 300km 남음
(7, 'VIN-SOON-003', 'K5', 72000, '기아', 2023, 21, 'GASOLINE', '66호3003', 49900, '2024-11-20', 'DRIVING', 27000000, 30000000, 5, 'GRAY', NOW(), NOW()), -- 100km 남음
(7, 'VIN-SOON-004', 'K5', 72000, '기아', 2023, 21, 'GASOLINE', '66호3004', 79500, '2024-10-01', 'WAITING', 27000000, 30000000, 5, 'WHITE', NOW(), NOW()), -- 500km 남음

-- 케이스 4. [정기검사 대상] 오늘(2026-01-14) 기준 검사 알림 테스트 (4대)
(7, 'VIN-INSP-001', '그랜저', 110000, '현대', 2023, 26, 'GASOLINE', '66허4001', 15000, '2025-07-14', 'WAITING', 42000000, 45000000, 5, 'BLACK', NOW(), NOW()), -- 오늘이 검사일 (6개월 주기 가정 시)
(7, 'VIN-INSP-002', '그랜저', 110000, '현대', 2023, 26, 'GASOLINE', '66허4002', 20000, '2025-07-10', 'WAITING', 42000000, 45000000, 5, 'GRAY', NOW(), NOW()), -- 4일 지남
(7, 'VIN-INSP-003', '그랜저', 110000, '현대', 2023, 26, 'GASOLINE', '66허4003', 25000, '2025-01-14', 'DRIVING', 42000000, 45000000, 5, 'WHITE', NOW(), NOW()), -- 정확히 1년 됨
(7, 'VIN-INSP-004', '그랜저', 110000, '현대', 2023, 26, 'GASOLINE', '66허4004', 30000, '2025-07-20', 'WAITING', 42000000, 45000000, 5, 'BLACK', NOW(), NOW()); -- 약 일주일 남음
...
-- 9. Maintenance (정비) 데이터 적재 (50건)
INSERT INTO maintenance (branch_id, car_id, employee_id, employee_name, vehicle_id_number, title, maintenance_date,
                         cost, status, detail, created_at, updated_at)
VALUES (2, 3, 4, '박수리', 'VIN003', '엔진오일 교체', '2026-01-09', 120000, 'ONGOING', '정기 점검 주기 도달', NOW(), NOW()),
       (2, 1, 4, '박수리', 'VIN001', '와이퍼 교체', '2025-12-20', 30000, 'COMPLETED', '동절기 대비', NOW(), NOW()),
       (2, 2, 4, '박수리', 'VIN002', '에어컨 필터 교체', '2026-01-05', 35000, 'COMPLETED', '냄새 발생으로 인한 교체', NOW(), NOW()),
       (2, 9, 4, '박수리', 'VIN009', '타이어 위치 교환', '2026-01-09', 20000, 'ONGOING', '편마모 방지', NOW(), NOW()),
       (2, 14, 4, '박수리', 'VIN014', '부동액 보충', '2026-01-09', 40000, 'ONGOING', '수위 낮음 확인', NOW(), NOW()),
       (3, 4, 6, '김왕십', 'VIN004', '엔진오일 교체', '2025-11-15', 85000, 'COMPLETED', '1만km 도달', NOW(), NOW()),
       (3, 5, 6, '김왕십', 'VIN005', '에어클리너 교체', '2025-12-10', 40000, 'COMPLETED', '오염 심각', NOW(), NOW()),
       (3, 10, 6, '김왕십', 'VIN010', '배터리 점검', '2026-01-09', 0, 'ONGOING', '시동 지연 현상', NOW(), NOW()),
       (3, 15, 6, '김왕십', 'VIN015', '브레이크 패드 점검', '2026-01-09', 0, 'SCHEDULE', '마모 한계선 근접', NOW(), NOW()),
       (4, 7, 8, '고현장', 'VIN007', '미션오일 교체', '2026-01-01', 250000, 'COMPLETED', '10만km 주기 도달', NOW(), NOW()),
       (4, 8, 8, '고현장', 'VIN008', '타이어 교체', '2026-01-09', 600000, 'ONGOING', '마모 한계 도달', NOW(), NOW()),
       (4, 13, 8, '고현장', 'VIN013', '엔진오일 교체', '2026-01-09', 130000, 'ONGOING', '주기 도달', NOW(), NOW()),
       (4, 18, 8, '고현장', 'VIN018', '와이퍼 교체', '2026-01-09', 30000, 'SCHEDULE', '빗물 자국 발생', NOW(), NOW()),
       (5, 11, 10, '신현장', 'VIN011', '엔진오일 교체', '2025-12-05', 90000, 'COMPLETED', '주기 도달', NOW(), NOW()),
       (5, 16, 10, '신현장', 'VIN016', '브레이크 오일 교환', '2026-01-09', 80000, 'ONGOING', '수분 함량 초과', NOW(), NOW()),
       (5, 21, 10, '신현장', 'VIN021', '실내 클리닝', '2026-01-09', 150000, 'SCHEDULE', '오염 심각', NOW(), NOW()),
       (6, 14, 12, '차현장', 'VIN014', '타이어 교체', '2026-01-09', 550000, 'ONGOING', '마모도 심각', NOW(), NOW()),
       (6, 19, 12, '차현장', 'VIN019', '엔진오일 교체', '2026-01-09', 95000, 'SCHEDULE', '주기 도달 예정', NOW(), NOW()),
       (7, 17, 14, '탁현장', 'VIN017', '점화플러그 교체', '2025-12-25', 160000, 'COMPLETED', '시동 불량 해결', NOW(), NOW()),
       (7, 22, 14, '탁현장', 'VIN022', '구동벨트 점검', '2026-01-09', 0, 'ONGOING', '소음 발생', NOW(), NOW()),
-- (추가 정비 데이터 30건 - ID 범위 내에서 랜덤 매핑)
       (2, 1, 4, '박수리', 'VIN001', '워셔액 보충', '2026-01-10', 5000, 'SCHEDULE', '부족 알림', NOW(), NOW()),
       (3, 4, 6, '김왕십', 'VIN004', '타이어 공기압 체크', '2026-01-11', 0, 'SCHEDULE', '계기판 알림', NOW(), NOW()),
       (4, 7, 8, '고현장', 'VIN007', '휠 밸런스 조정', '2026-01-12', 40000, 'SCHEDULE', '고속 주행 떨림', NOW(), NOW()),
       (5, 11, 10, '신현장', 'VIN011', '에어컨 가스 충전', '2026-01-13', 50000, 'SCHEDULE', '냉방 성능 저하', NOW(), NOW()),
       (6, 14, 12, '차현장', 'VIN014', '전조등 교체', '2026-01-14', 15000, 'SCHEDULE', '램프 단선', NOW(), NOW()),
       (7, 17, 14, '탁현장', 'VIN017', '배터리 교체', '2026-01-15', 140000, 'SCHEDULE', '방전 이력 있음', NOW(), NOW()),
       (2, 2, 4, '박수리', 'VIN002', '엔진오일세트', '2026-01-16', 110000, 'SCHEDULE', '주기 도달', NOW(), NOW()),
       (3, 5, 6, '김왕십', 'VIN005', '브레이크 패드', '2026-01-17', 120000, 'SCHEDULE', '소음 발생', NOW(), NOW()),
       (4, 8, 8, '고현장', 'VIN008', '미션오일', '2026-01-18', 220000, 'SCHEDULE', '변속 충격', NOW(), NOW()),
       (5, 16, 10, '신현장', 'VIN016', '부동액', '2026-01-19', 45000, 'SCHEDULE', '교체 주기', NOW(), NOW()),
       (6, 19, 12, '차현장', 'VIN019', '에어클리너', '2026-01-20', 25000, 'SCHEDULE', '오염', NOW(), NOW()),
       (7, 22, 14, '탁현장', 'VIN022', '타이어 위치교환', '2026-01-21', 20000, 'SCHEDULE', '편마모 예방', NOW(), NOW()),
       (2, 3, 4, '박수리', 'VIN003', '실내 항균 탈취', '2026-01-22', 30000, 'SCHEDULE', '고객 요청', NOW(), NOW()),
       (3, 6, 6, '김왕십', 'VIN006', '와이퍼', '2026-01-23', 35000, 'SCHEDULE', '교체 필요', NOW(), NOW()),
       (4, 9, 8, '고현장', 'VIN009', '워셔액', '2026-01-24', 5000, 'SCHEDULE', '보충', NOW(), NOW()),
       (5, 12, 10, '신현장', 'VIN012', '엔진오일', '2026-01-25', 95000, 'SCHEDULE', '주기 도달', NOW(), NOW()),
       (6, 15, 12, '차현장', 'VIN015', '브레이크 오일', '2026-01-26', 85000, 'SCHEDULE', '수분 과다', NOW(), NOW()),
       (7, 18, 14, '탁현장', 'VIN018', '배터리', '2026-01-27', 130000, 'SCHEDULE', '전압 불안정', NOW(), NOW()),
       (2, 1, 4, '박수리', 'VIN001', '점화플러그', '2026-01-28', 150000, 'SCHEDULE', '가속 불량', NOW(), NOW()),
       (3, 4, 6, '김왕십', 'VIN004', '구동벨트', '2026-01-29', 280000, 'SCHEDULE', '크랙 발생', NOW(), NOW()),
       (4, 7, 8, '고현장', 'VIN007', '타이어', '2026-01-30', 650000, 'SCHEDULE', '교체 시기', NOW(), NOW()),
       (5, 10, 10, '신현장', 'VIN010', '휠 밸런스', '2026-01-31', 40000, 'SCHEDULE', '핸들 떨림', NOW(), NOW()),
       (6, 13, 12, '차현장', 'VIN013', '얼라인먼트', '2026-02-01', 60000, 'SCHEDULE', '쏠림 현상', NOW(), NOW()),
       (7, 16, 14, '탁현장', 'VIN016', '에어컨 필터', '2026-02-02', 25000, 'SCHEDULE', '주기 도달', NOW(), NOW()),
       (2, 19, 4, '박수리', 'VIN019', '엔진오일', '2026-02-03', 100000, 'SCHEDULE', '주기 도달', NOW(), NOW()),
       (3, 22, 6, '김왕십', 'VIN022', '미션오일', '2026-02-04', 230000, 'SCHEDULE', '주기 도달', NOW(), NOW()),
       (4, 2, 8, '고현장', 'VIN002', '브레이크 패드', '2026-02-05', 110000, 'SCHEDULE', '소음', NOW(), NOW()),
       (5, 5, 10, '신현장', 'VIN005', '부동액', '2026-02-06', 50000, 'SCHEDULE', '교체', NOW(), NOW()),
       (6, 8, 12, '차현장', 'VIN008', '와이퍼', '2026-02-07', 30000, 'SCHEDULE', '교체', NOW(), NOW()),
       (7, 11, 14, '탁현장', 'VIN011', '워셔액', '2026-02-08', 5000, 'SCHEDULE', '보충', NOW(), NOW());


-- 10. Alert (알림) 데이터 적재 (30건)
INSERT INTO alert (employee_id, type, message, date, created_at, updated_at)
VALUES (1, 'ACCIDENT', '[긴급] 가락시장지점 소나타 사고 접수. 확인 요망', '2026-01-09', NOW(), NOW()),
       (2, 'NOTICE', '전사 공지: 보안 점검 안내', '2026-01-08', NOW(), NOW()),
       (3, 'ACCIDENT', '[지점사고] 소속 지점 K5 사고 발생', '2026-01-09', NOW(), NOW()),
       (4, 'MAINTENANCE', '담당 차량 엔진오일 교체 주기 도달', '2026-01-09', NOW(), NOW()),
       (5, 'APPROVAL', '세차 완료 승인 요청', '2026-01-09', NOW(), NOW()),
       (6, 'SYSTEM', '비밀번호 변경 권장 알림', '2026-01-05', NOW(), NOW()),
       (7, 'ACCIDENT', '[지점사고] 소속 지점 그랜저 접촉 사고', '2026-01-09', NOW(), NOW()),
       (8, 'MAINTENANCE', '타이어 교체 업무 할당됨', '2026-01-09', NOW(), NOW()),
       (9, 'NOTICE', '신도림 지점 회식 안내', '2026-01-07', NOW(), NOW()),
       (10, 'MAINTENANCE', '브레이크 패드 점검 요망', '2026-01-09', NOW(), NOW()),
       (11, 'APPROVAL', '정비 완료 승인 대기 중', '2026-01-09', NOW(), NOW()),
       (12, 'MAINTENANCE', '엔진오일 교체 주기 임박', '2026-01-09', NOW(), NOW()),
       (13, 'ACCIDENT', '[긴급] 공덕지점 아반떼 사고 접수', '2026-01-09', NOW(), NOW()),
       (14, 'SYSTEM', '시스템 점검 예정 안내', '2026-01-08', NOW(), NOW()),
       (3, 'MAINTENANCE', '지점 가동률 90% 초과 경고', '2026-01-09', NOW(), NOW()),
       (5, 'NOTICE', '본사 지침 전달 사항', '2026-01-06', NOW(), NOW()),
       (7, 'APPROVAL', '차량 상태 점검 보고서 승인 요청', '2026-01-09', NOW(), NOW()),
       (9, 'MAINTENANCE', '정비 대기 차량 증가 알림', '2026-01-09', NOW(), NOW()),
       (11, 'SYSTEM', '개인정보 취급 방침 변경 안내', '2026-01-01', NOW(), NOW()),
       (13, 'NOTICE', '월간 매출 마감 안내', '2026-01-31', NOW(), NOW()),
       (1, 'APPROVAL', '휴가 신청 승인 대기', '2026-01-09', NOW(), NOW()),
       (2, 'MAINTENANCE', '전사 차량 정비 현황 보고', '2026-01-09', NOW(), NOW()),
       (4, 'SYSTEM', '로그인 시도 알림', '2026-01-09', NOW(), NOW()),
       (6, 'NOTICE', '주말 근무 일정 안내', '2026-01-09', NOW(), NOW()),
       (8, 'ACCIDENT', '[지점사고] 사당지점 접촉 사고 처리 완료', '2026-01-08', NOW(), NOW()),
       (10, 'APPROVAL', '비품 구매 요청 승인', '2026-01-09', NOW(), NOW()),
       (12, 'MAINTENANCE', '배터리 교체 주기 도달', '2026-01-09', NOW(), NOW()),
       (14, 'SYSTEM', '업데이트 완료 알림', '2026-01-09', NOW(), NOW()),
       (3, 'NOTICE', '우수 사원 포상 안내', '2026-01-05', NOW(), NOW()),
       (7, 'MAINTENANCE', '차량 정기 검사 일정 안내', '2026-01-09', NOW(), NOW());