...
VALUES (1, 'ACCIDENT', '[긴급] 가락시장지점 소나타 사고 접수. 확인 요망', '2026-01-09', false, NOW(), NOW()),
       ...
       (10, 'ACCIDENT', '[추가] 10번 사원 담당 차량 경미한 접촉 사고 접수', '2026-01-10', false, NOW(), NOW()),
       (10, 'MAINTENANCE', '담당 차량 정기 점검 리스트 업데이트', '2026-01-11', false, NOW(), NOW()),
       (10, 'NOTICE', '지점 내 비품 정리 협조 요청', '2026-01-11', false, NOW(), NOW()),
       (10, 'APPROVAL', '신규 업무 분장 승인 대기', '2026-01-12', false, NOW(), NOW()),
       (10, 'SYSTEM', '보안 로그인이 확인되었습니다.', '2026-01-12', false, NOW(), NOW()),
       (10, 'MAINTENANCE', '담당 차량 와이퍼 교체 알림', '2026-01-13', false, NOW(), NOW()),
       (10, 'ACCIDENT', '[긴급] 10번 사원 관리 구역 내 사고 발생', '2026-01-14', false, NOW(), NOW()),
       (10, 'NOTICE', '분기별 CS 교육 일정 안내', '2026-01-14', false, NOW(), NOW()),
       (10, 'APPROVAL', '연차 신청서 승인 완료', '2026-01-15', false, NOW(), NOW()),
       (10, 'MAINTENANCE', '차량 냉각수 보충 주기 도달', '2026-01-16', false, NOW(), NOW()),
       (10, 'SYSTEM', '시스템 업데이트가 완료되었습니다.', '2026-01-16', false, NOW(), NOW()),
       (10, 'NOTICE', '사내 식당 식단표 안내', '2026-01-17', false, NOW(), NOW()),
       (10, 'ACCIDENT', '이전 사고 처리 결과 보고서 도착', '2026-01-18', false, NOW(), NOW()),
       (10, 'MAINTENANCE', '차량 에어컨 필터 교체 권장', '2026-01-19', false, NOW(), NOW()),
       (10, 'APPROVAL', '외부 교육 신청 승인 대기', '2026-01-20', false, NOW(), NOW()),
       (10, 'NOTICE', '주차장 이용 제한 안내', '2026-01-21', false, NOW(), NOW()),
       (10, 'SYSTEM', '장기 미사용 비밀번호 변경 안내', '2026-01-22', false, NOW(), NOW()),
       (10, 'MAINTENANCE', '지점 가동 차량 세차 업무 할당', '2026-01-22', false, NOW(), NOW()),
       (10, 'ACCIDENT', '[지점] 보험사 출동 확인 메시지', '2026-01-23', false, NOW(), NOW()),
       (10, 'APPROVAL', '유류비 청구 건 승인 완료', '2026-01-23', false, NOW(), NOW());