...
-- 3. Client (고객) - 20명
INSERT INTO client (email, name, birthday, gender, resident_number, licence_number, licence_area, licence_day, password,
                    blacklisted,
                    blacklist_info, phone_number, created_at, updated_at)
VALUES ('kim@pickcar.com', '김민수', '1992-03-15', 'MALE', '920315-1', '11-22-123456-11', '서울', '2015-05-20', 'Pass123!',
        false, NULL,
        '010-1234-5678', NOW(), NOW()),
       ('lee@pickcar.com', '이영희', '1995-07-22', 'FEMALE', '950722-2', '22-33-654321-22', '경기', '2018-11-10', 'Pass123!',
        false,
        NULL, '010-2345-6789', NOW(), NOW()),
       ('park@pickcar.com', '박철호', '1988-12-05', 'MALE', '881205-1', '13-11-112233-33', '인천', '2010-02-15', 'Pass123!',
        true,
        '상습 연체', '010-3456-7890', NOW(), NOW()),
       ('choi@pickcar.com', '최지우', '1998-01-30', 'FEMALE', '980130-2', '11-99-887766-44', '서울', '2020-06-01',
        'Pass123!', false,
        NULL, '010-4567-8901', NOW(), NOW()),
       ('jung@pickcar.com', '정대만', '1993-05-22', 'MALE', '930522-1', '12-44-556677-55', '강원', '2016-09-12', 'Pass123!',
        false, NULL,
        '010-5678-9012', NOW(), NOW()),
       ('kang@pickcar.com', '강백호', '1997-04-01', 'MALE', '970401-1', '15-22-334455-66', '부산', '2019-10-20', 'Pass123!',
        false, NULL,
        '010-6789-0123', NOW(), NOW()),
       ('yoon@pickcar.com', '윤세리', '1991-08-11', 'FEMALE', '910811-2', '11-55-998877-77', '서울', '2014-03-05',
        'Pass123!', false,
        NULL, '010-7890-1234', NOW(), NOW()),
       ('han@pickcar.com', '한결', '1985-06-18', 'MALE', '850618-1', '21-66-778899-88', '경남', '2008-07-22', 'Pass123!',
        false, NULL,
        '010-8901-2345', NOW(), NOW()),
       ('lim@pickcar.com', '임상옥', '1980-02-14', 'MALE', '800214-1', '17-77-112244-99', '전북', '2005-12-01', 'Pass123!',
        true,
        '사고 미신고', '010-9012-3456', NOW(), NOW()),
       ('ko@pickcar.com', '고은아', '1996-10-25', 'FEMALE', '961025-2', '11-88-223344-00', '서울', '2021-01-15', 'Pass123!',
        false, NULL,
        '010-0123-4567', NOW(), NOW()),
       ('son@pickcar.com', '손흥민', '1992-07-08', 'MALE', '920708-1', '11-11-777777-11', '강원', '2012-08-30', 'Pass123!',
        false, NULL,
        '010-1111-7777', NOW(), NOW()),
       ('faker@pickcar.com', '이상혁', '1996-05-07', 'MALE', '960507-1', '11-22-555555-55', '서울', '2017-04-21', 'Pass123!',
        false,
        NULL, '010-5555-5555', NOW(), NOW()),
       ('iu@pickcar.com', '이지은', '1993-05-16', 'FEMALE', '930516-2', '11-33-333333-33', '서울', '2014-06-10', 'Pass123!',
        false, NULL,
        '010-5160-5160', NOW(), NOW()),
       ('suzy@pickcar.com', '배수지', '1994-10-10', 'FEMALE', '941010-2', '11-44-444444-44', '광주', '2015-11-20',
        'Pass123!', false,
        NULL, '010-1010-1010', NOW(), NOW()),
       ('v@pickcar.com', '김태형', '1995-12-30', 'MALE', '951230-1', '11-55-555555-55', '대구', '2016-01-10', 'Pass123!',
        false, NULL,
        '010-1230-1230', NOW(), NOW()),
       ('jennie@pickcar.com', '김제니', '1996-01-16', 'FEMALE', '960116-2', '11-66-666666-66', '서울', '2017-09-05',
        'Pass123!', false,
        NULL, '010-0116-0116', NOW(), NOW()),
       ('bogum@pickcar.com', '박보검', '1993-06-16', 'MALE', '930616-1', '11-77-777777-77', '서울', '2013-12-25', 'Pass123!',
        false,
        NULL, '010-0616-0616', NOW(), NOW()),
       ('bin@pickcar.com', '현빈', '1982-09-25', 'MALE', '820925-1', '11-88-888888-88', '서울', '2004-10-11', 'Pass123!',
        false, NULL,
        '010-0925-0925', NOW(), NOW()),
       ('yejin@pickcar.com', '손예진', '1982-01-11', 'FEMALE', '820111-2', '11-99-999999-99', '대구', '2003-05-20',
        'Pass123!', false,
        NULL, '010-0111-0111', NOW(), NOW()),
       ('minji@pickcar.com', '민지', '2004-05-07', 'FEMALE', '040507-4', '11-00-000000-00', '강원', '2023-06-01',
        'Pass123!', false,
...
INSERT INTO coupon (coupon_name, discount, code, max_quantity, issued_quantity, start_date, end_date, exp_date, created_at, updated_at)
VALUES
    ('신규 가입 축하 쿠폰', 10000, 'WELCOME2026', 1000, 0, '2026-01-01', '2026-12-31', '2026-12-31', NOW(), NOW()),
    ('VIP 전용 특별 할인권', 50000, 'VIPONLY50', 100, 0, '2026-01-01', '2026-12-31', '2026-12-31', NOW(), NOW()),
    ('생일 축하 기프트 쿠폰', 20000, 'HBD2026', 500, 0, '2026-01-01', '2026-12-31', '2026-12-31', NOW(), NOW()),
    ('장거리 이용 감사 쿠폰', 30000, 'LONGDIST30', 200, 0, '2026-01-01', '2026-07-31', '2026-07-31', NOW(), NOW()),
    ('주말 나들이 응원 쿠폰', 15000, 'WEEKEND15', 300, 0, '2026-01-01', '2026-05-31', '2026-05-31', NOW(), NOW()),
    ('가락시장지점 단독 할인', 12000, 'GARAK12', 150, 0, '2026-01-01', '2026-03-31', '2026-03-31', NOW(), NOW()),
    ('사당역 환승객 이벤트', 8000, 'SADANG08', 400, 0, '2026-01-01', '2026-04-30', '2026-04-30', NOW(), NOW()),
    ('왕십리 대학생 응원권', 10000, 'WANG10', 250, 0, '2026-01-01', '2026-06-30', '2026-06-30', NOW(), NOW()),
    ('신도림 출퇴근 할인권', 7000, 'DORIM07', 350, 0, '2026-01-01', '2026-08-31', '2026-08-31', NOW(), NOW()),
    ('노원 지점 첫 방문 할인', 5000, 'NOWON05', 200, 0, '2026-01-01', '2026-02-28', '2026-02-28', NOW(), NOW()),
    ('정비 지연 사과 쿠폰', 25000, 'SORRY25', 100, 0, '2026-01-01', '2026-12-31', '2026-12-31', NOW(), NOW()),
    ('차량 청결 우수 리뷰권', 3000, 'CLEAN03', 1000, 0, '2026-01-01', '2026-03-31', '2026-03-31', NOW(), NOW()),
    ('앱 업데이트 감사 쿠폰', 4000, 'UPDATE04', 5000, 0, '2026-01-01', '2026-01-31', '2026-01-31', NOW(), NOW()),
    ('설문조사 참여 보상', 2000, 'SURVEY02', 2000, 0, '2026-01-01', '2026-03-31', '2026-03-31', NOW(), NOW()),
    ('서비스 개선 쿠폰', 10000, 'VROOM10', 300, 0, '2026-01-01', '2026-12-31', '2026-12-31', NOW(), NOW());

-- 7. Client_Coupon (고객 보유 쿠폰) - 총 30건
-- client_id: 1~20, coupon_id: 1~15

INSERT INTO client_coupon (client_id, coupon_id, is_used, used_at, created_at, updated_at)
VALUES
-- 1. 김민수 (ID 1) - 충성 고객
(1, 1, true, '2025-05-21 14:00:00', NOW(), NOW()),   -- 신규 가입 쿠폰 (사용 완료)
(1, 2, false, NULL, NOW(), NOW()),                   -- VIP 전용 특별 할인권 (미사용)
(1, 3, false, NULL, NOW(), NOW()),                   -- 생일 축하 쿠폰 (3월 생일, 미사용)
-- 2. 이영희 (ID 2)
(2, 1, true, '2025-11-10 10:00:00', NOW(), NOW()),   -- 신규 가입 쿠폰 (사용 완료)
(2, 5, false, NULL, NOW(), NOW()),                   -- 주말 나들이 응원 쿠폰 (미사용)
-- 3. 박철호 (ID 3) - 블랙리스트 (쿠폰 사용 제한적일 수 있으나 과거 내역 존재)
(3, 1, true, '2024-01-01 09:00:00', NOW(), NOW()),   -- 신규 가입 쿠폰 (오래전 사용)
-- 4. 최지우 (ID 4)
(4, 1, false, NULL, NOW(), NOW()),                   -- 신규 가입 쿠폰 (아직 안 씀)
(4, 8, false, NULL, NOW(), NOW()),                   -- 왕십리 대학생 응원권 (보유)
-- 5. 정대만 (ID 5)
(5, 4, true, '2025-09-15 12:00:00', NOW(), NOW()),   -- 장거리 이용 감사 쿠폰 (사용 완료)
(5, 13, false, NULL, NOW(), NOW()),                  -- 앱 업데이트 감사 쿠폰 (미사용)
-- 6. 강백호 (ID 6)
(6, 12, true, '2025-10-25 15:30:00', NOW(), NOW()),  -- 차량 청결 우수 리뷰권 (사용 완료)
-- 7. 윤세리 (ID 7)
(7, 2, false, NULL, NOW(), NOW()),                   -- VIP 전용 특별 할인권 (미사용)
(7, 6, false, NULL, NOW(), NOW()),                   -- 가락시장지점 단독 할인 (미사용)
-- 8. 한결 (ID 8)
(8, 1, true, '2025-07-25 11:00:00', NOW(), NOW()),   -- 신규 가입 쿠폰 (사용 완료)
(8, 11, false, NULL, NOW(), NOW()),                  -- 정비 지연 사과 쿠폰 (보유)
-- 9. 임상옥 (ID 9) - 블랙리스트
(9, 14, true, '2025-12-05 18:00:00', NOW(), NOW()),  -- 설문조사 참여 보상 (사용 완료)
-- 10. 고은아 (ID 10)
(10, 1, false, NULL, NOW(), NOW()),                  -- 신규 가입 쿠폰 (미사용)
(10, 9, false, NULL, NOW(), NOW()),                  -- 신도림 출퇴근 할인권 (미사용)
-- 11. 손흥민 (ID 11) - 우수 고객
(11, 2, false, NULL, NOW(), NOW()),                  -- VIP 전용 특별 할인권 (미사용)
(11, 4, false, NULL, NOW(), NOW()),                  -- 장거리 이용 감사 쿠폰 (미사용)
(11, 15, true, '2025-08-30 09:00:00', NOW(), NOW()), -- 서비스 개선 쿠폰 (사용 완료)
-- 12. 이상혁 (ID 12)
(12, 13, true, '2025-04-22 20:00:00', NOW(), NOW()), -- 앱 업데이트 감사 쿠폰 (사용 완료)
(12, 7, false, NULL, NOW(), NOW()),                  -- 사당역 환승객 이벤트 (미사용)
-- 13. 이지은 (ID 13)
(13, 3, false, NULL, NOW(), NOW()),                  -- 생일 축하 기프트 쿠폰 (5월 생일, 미사용)
(13, 5, false, NULL, NOW(), NOW()),                  -- 주말 나들이 응원 쿠폰 (미사용)
-- 14. 배수지 (ID 14)
(14, 1, true, '2025-11-20 13:00:00', NOW(), NOW()),  -- 신규 가입 쿠폰 (사용 완료)
-- 15. 김태형 (ID 15)
(15, 10, false, NULL, NOW(), NOW()),                 -- 노원 지점 첫 방문 할인 (미사용)
-- 16. 김제니 (ID 16)
(16, 2, false, NULL, NOW(), NOW()),                  -- VIP 전용 특별 할인권 (미사용)
-- 17. 박보검 (ID 17)
(17, 12, true, '2025-12-30 16:00:00', NOW(), NOW()), -- 차량 청결 우수 리뷰권 (사용 완료)
-- 18. 현빈 (ID 18)
(18, 1, true, '2024-10-15 10:00:00', NOW(), NOW()),  -- 신규 가입 쿠폰 (사용 완료)
(18, 4, false, NULL, NOW(), NOW()),                  -- 장거리 이용 감사 쿠폰 (미사용)
-- 19. 손예진 (ID 19)
(19, 14, false, NULL, NOW(), NOW()),                 -- 설문조사 참여 보상 (미사용)
-- 20. 민지 (ID 20) - 신규 가입
(20, 1, false, NULL, NOW(), NOW());
-- 신규 가입 축하 쿠폰 (미사용)
